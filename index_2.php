                    ...
                    <ul class="features-items">
                        <li class="feature-item">
                            ...
                            <div class="right-content">
                                <h4>Basic Fitness</h4>
                                <p>Joining Basic-Fit is a great first step. Now you have to find your routine. That's where Basic-Fit is ready to help.</p>
                                <a target="blank" href=" https://www.basic-fit.com/en-es/why-basic-fit" class="text-button">Discover More</a>
                            </div>
                        </li>
                        <li class="feature-item">
                            <div class="left-icon">
                            ...
                            <div class="right-content">
                                ...
                                <p>Whether you're just starting out this fast-track workout plan will help you drastically improve your physique and fitness levels.</p>
                                <a  href="https://www.muscleandfitness.com/workout-plan/workouts/workout-routines/complete-mf-beginners-training-guide-plan/" target="blank" class="text-button">Discover More</a>
                            </div>
                        </li>
                        <li class="feature-item">
                            <div class="left-icon">
                            ...
                            <div class="right-content">
                                ...
                                <p>This strength and muscle program is not just for beginners. </p>
                                <a target="blank" href="https://www.verywellfit.com/basic-strength-and-muscle-weight-training-program-3498523" class="text-button">Discover More</a>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="features-items">
                        <li class="feature-item">
                            ...
                            <div class="right-content">
                                ...
                                <p>Boost your muscle and strength gains by learning how to use drop sets,rest pause training.</p>
                                <a target="blank" href="https://www.muscleandstrength.com/articles/guide-to-advanced-muscle-building-training-techniques.html" class="text-button">Discover More</a>
                            </div>
                        </li>
                        <li class="feature-item">
                            <div class="left-icon">
                            ...
                            <div class="right-content">
                                <h4>Yoga Training</h4>
                                <p>Yoga Teacher Training
                                  Browse and choose from the largest selection of Yoga Teacher Training courses worldwide</p>
                                <a href="https://www.bookyogaretreats.com/all/c/yoga-teacher-training" target="blank" class="text-button">Discover More</a>
                            </div>
                        </li>
                        <li class="feature-item">
                            <div class="left-icon">
                            ...
                            <div class="right-content">
                                ...
                                <p>Become a better lifter with yoga! Stretch and strengthen key muscles, improve posture and get rid of aches and pains.</p>
                                <a href="https://www.udemy.com/topic/body-building/" target="blank" class="text-button">Discover More</a>
                            </div>
                        </li>
                    </ul>
                </div>
